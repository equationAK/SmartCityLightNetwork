        ...
        <div class="col-span-1 row-span-2 self-center">
            ...
            <div class="widget">
                ...
                <div class="right-panel panel">
                    <img src="../partials/png/filadelfeia.png" alt="" width="160">
                </div>
            </div>
        </div>
                    ...
                    <?php foreach ($data['dataSensor'] as $sensor) : ?>
                        <?php if ($sensor['poleID'] == $poleID) : ?>
                            <div class="flex justify-between mb-1">
                                <span class="text-base font-medium text-blue-700 dark:text-white"><?= $sensor['DisplayNameGr']; ?></span>
                                <span class="text-sm font-medium text-blue-700 dark:text-white" id="<?= $sensor['colName'] ?>"><?= intval($sensor['value']); ?>%</span>
                            </div>
                            <div class="w-full bg-gray-200 rounded-full h-2.5 dark:bg-gray-700">
                                <div class="bg-blue-600 h-2.5 rounded-full" style="width: <?= $sensor['value']; ?>%"></div>
                            </div>
                        <?php endif; ?>
                    <?php endforeach; ?>
                </div>
